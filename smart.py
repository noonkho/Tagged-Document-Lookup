...
# random.seed(15) # I like the number 15 (make sure I get same randomness for basic.y)
...
def initalize_smart():
    ...
    for i in range(size):
        ...
        docs.append(SmartDoc(i,tags_primes))
...
# simple_docs = [SmartDoc(1,[("1",2),("2",3),("3",5)]),SmartDoc(2,[("1",2),("3",5),("5",11)]),SmartDoc(3,[("2",3),("4",7),("5",11)]),
#                 SmartDoc(4,[("2",3),("3",5),("6",13)]),SmartDoc(5,[("2",3),("5",11)])]
